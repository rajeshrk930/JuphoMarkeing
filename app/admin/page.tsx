    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
              <button
                onClick={exportToCSV}
                className="flex-1 sm:flex-initial bg-[#FF6A00] hover:bg-[#CC5500] px-4 py-2 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-sm"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-5 border-l-4 border-[#FF6A00]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {filteredLeads.map((lead, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {lead.Website && (
                          <a
                            ...
                            className="text-xs text-[#FF6A00] hover:text-[#FF8533] flex items-center gap-1 mt-1"
                          >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <a href={`mailto:${lead.Email}`} className="text-sm text-[#FF6A00] hover:text-[#FF8533] block">
                          {lead.Email}
                        </a>
                        {lead.Phone && (
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <a href={`mailto:${selectedLead.Email}`} className="text-[#FF6A00] hover:text-[#FF8533] font-medium break-all">
                    {selectedLead.Email}
                  </a>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  {selectedLead.Website ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#FF6A00] hover:text-[#FF8533] font-medium flex items-center gap-1 break-all"
                    >
                      {selectedLead.Website}
              ...
              <div className="flex gap-3 pt-4 border-t">
                ...
                {selectedLead.Phone && (
                  <a
                    ...
                    className="flex-1 bg-[#FF6A00] hover:bg-[#CC5500] text-white py-3 rounded-lg font-semibold text-center transition-colors flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
