      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 md:py-5 w-full">
        <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-10 items-center">
          ...
          >
            ...
            >
              <div className="flex items-start gap-2.5 text-white">
                <svg className="w-5 h-5 text-[#FF6A00] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <motion.div
            ...
            className="bg-[#1a1a1a] rounded-xl p-6 md:p-7 shadow-2xl w-full max-w-md md:max-w-sm mx-auto md:mx-0 border border-[#333333]"
          >
            ...
            <div className="mt-4 flex items-center gap-2 text-xs md:text-xs text-[#C7D0E0]">
              <svg className="w-4 h-4 text-[#FF6A00] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
