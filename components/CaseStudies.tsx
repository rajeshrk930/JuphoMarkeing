...
export default function CaseStudies() {
  return (
    <section id="case-studies" className="w-full bg-bgSection py-12 md:py-18">
      <div className="max-w-5xl mx-auto px-4">
        <div className="mb-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Recent Results</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {studies.map((s, i) => (
            <div key={i} className="group bg-bgCard rounded-md border border-[#FF7A00]/30 p-5 shadow-lg hover:shadow-xl hover:border-[#FF7A00] transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-white">{s.client}</h3>
                <span className="inline-block text-xs font-medium bg-[#FF7A00] text-white px-2 py-1 rounded">
                  {s.time}
                </span>
              </div>
        ...
        <p className="text-xs text-textSecondary font-medium mt-6 text-center">
